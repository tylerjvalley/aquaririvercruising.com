                        ...
                        <div className="content">
                            <div className="inner">
                                ...
                                <ul className="feature-list">
                                    <li className="text">Unpack only once, the rest of the time your hotel will travel with you.</li>
                                    <li className="text">Scenic sailings provide views unattainable by land.</li>
                                    <li className="text">Made friends onland? <br/> Bring them aboard for dinner or have them join you for a drink in the lounge.</li>
                                    <li className="text">With our set sailing schedule, you know where we're going and you plan your exploration around it.</li>
